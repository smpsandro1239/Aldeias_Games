...
-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('SUPER_ADMIN', 'ALDEIA_ADMIN', 'GESTOR', 'COLABORADOR', 'MODERADOR', 'VIEWER', 'MEMBRO');
...
CREATE TABLE "aldeias" (
    ...
    "logoUrl" TEXT,
    "logoBase64" TEXT,
    "moedaInterna" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE "UserAldeiaRole" (
    ...
    CONSTRAINT "UserAldeiaRole_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "UserAldeiaRole_userId_aldeiaId_roleId_key" ON "UserAldeiaRole"("userId", "aldeiaId", "roleId");
...
-- CreateIndex
CREATE INDEX "game_analytics_aldeiaId_idx" ON "game_analytics"("aldeiaId");

-- CreateIndex
CREATE INDEX "numeros_vendidos_jogoId_idx" ON "numeros_vendidos"("jogoId");

-- CreateIndex
CREATE INDEX "numeros_vendidos_numero_idx" ON "numeros_vendidos"("numero");
