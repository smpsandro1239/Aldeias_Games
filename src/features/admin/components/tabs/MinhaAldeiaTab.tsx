...
import {
  ...
  Power, PowerOff, Trash2, Edit, Eye,
                              ...
                              <>
                                ...
                                <div className="space-y-1">
                                  {evJogos.map((jg) => (
                                    <div
                                      key={jg.id}
                                      className="flex items-center justify-between px-3 py-2 rounded-md hover:bg-accent/50 transition-colors group cursor-pointer"
        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          {jogoDetailLoading ? (
            ...
            <div className="space-y-4">
              ...
              {jogoDetail.configuracao?.premios?.length > 0 && (
                <div>
                  <h4 className="text-sm font-medium mb-2 flex items-center gap-1.5">
                    <Trophy className="h-3.5 w-3.5" /> Prémios
                  </h4>
                  <div className="space-y-1">
                    {jogoDetail.configuracao.premios.map((p: any, i: number) => (
