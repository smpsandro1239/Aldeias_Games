...
// Safe parsing helpers (though not needed here, included for consistency)
...
export function TransparencyModal({
  ...
  const copyHash = useCallback(() => {
    if (navigator.clipboard) {
      ...
      textArea.value = verificationHash;
  ...
  const generateWhatsAppMessage = useCallback(() => {
    const tipoJogoNome = GAME_TYPE_NAMES[data.tipoJogo] || data.tipoJogo;
  ...
  const getTipoJogoNome = useCallback(() => {
    return GAME_TYPE_NAMES[data.tipoJogo] || data.tipoJogo;
  }, [data.tipoJogo]);
    ...
    <AnimatePresence>
      {open && (
        <Dialog open={open} onOpenChange={onOpenChange}>
          <DialogContent className="max-w-lg w-[95vw] max-h-[90vh] overflow-y-auto p-0" aria-describedby="transparency-modal-description">
            ...
            >
              <div className="bg-emerald-500 text-foreground shadow-md p-6 rounded-lg">
                <Shield className="w-12 h-12 mx-auto mb-2 text-foreground" aria-hidden="true" />
                <h3 className="text-xl font-medium mb-4">Resumo de Rentabilidade e Transparência</h3>
              </div>

              <div className="p-6 space-y-6" id="transparency-modal-description">
                ...
                <div className="space-y-3">
                  <h3 className="font-semibold text-accent flex items-center gap-2">
                    <Euro className="w-4 h-4" aria-hidden="true" /> Receita Esperada
                  </h3>
                  <div className="bg-surface-container-low rounded-xl p-4 space-y-2">
                ...
                <div className="space-y-3">
                  <h3 className="font-semibold text-accent flex items-center gap-2">
                    <Trophy className="w-4 h-4" aria-hidden="true" /> Prémios
                  </h3>
                  <div className="bg-surface-container-low rounded-xl p-4 space-y-2">
                ...
                <div className="space-y-3">
                  <h3 className="font-semibold text-accent flex items-center gap-2">
                    <TrendingUp className="w-4 h-4" aria-hidden="true" /> Análise de Rentabilidade
                  </h3>
                ...
                <div className="bg-surface-container-low rounded-xl p-4">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="text-sm font-semibold text-accent flex items-center gap-2">
                      <Hash className="w-4 h-4" aria-hidden="true" /> Hash de Verificação
                    </h4>
                    <Button type="button" variant="ghost" size="sm" onClick={copyHash} className="h-7 text-xs">
                ...
                <div className="flex gap-2">
                  <Button type="button" variant="outline" size="sm" onClick={shareWhatsApp} className="flex-1 bg-primary/10 border-green-500/30 text-primary hover:bg-primary/20">
                    <Share2 className="w-4 h-4 mr-2" aria-hidden="true" /> WhatsApp
                  </Button>
                  <Button type="button" variant="outline" size="sm" onClick={printSummary} className="flex-1">
