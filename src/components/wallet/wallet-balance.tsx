...
export function WalletBalance({ token, className = "", showAddButton = true, compact = false }: WalletBalanceProps) {
  ...
  if (loading) {
    return (
      <div className={`bg-gradient-to-br from-surface-container to-surface-container-low rounded-2xl p-4 border border-primary/20 ${className}`}>
        <div className="animate-pulse">
          <div className="h-4 w-20 bg-surface-container-low rounded mb-2" />
    ...
    return (
      <div className={`flex items-center gap-3 ${className}`}>
        ...
        <div>
          ...
          <p className="font-bold text-foreground">{formatCurrency(saldo)}</p>
        </div>
        {showAddButton && (
          <button
            onClick={() => setAddBalanceOpen(true)}
            className="ml-auto p-2 bg-primary rounded-xl hover:bg-primary/90 transition-colors"
          >
  ...
  return (
    <>
      <div className={`bg-gradient-to-br from-surface-container to-surface-container-low rounded-2xl p-5 border border-primary/20 relative overflow-hidden ${className}`}>
        ...
        <div className="relative">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">Saldo Aldeias</span>
            </div>
            <Badge variant="outline" className="bg-primary/10 text-secondary border-secondary/30">
              <Sparkles className="h-3 w-3 mr-1" />
              5% Cashback
            </Badge>
          </div>
          
          <p className="text-3xl font-bold text-foreground mb-1 font-serif italic">
...
export function AddBalanceModal({ open, onOpenChange, onSuccess, token }: AddBalanceModalProps) {
    ...
    switch (step) {
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold text-foreground mb-2">Adicionar Saldo</h3>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="0.00"
                  className="pl-10 bg-surface-container-low border-outline-variant/30 text-foreground text-xl font-bold text-center"
                />
              </div>
            </div>
      ...
      case "method":
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold text-foreground mb-2">Método de Pagamento</h3>
              <p className="text-sm text-muted-foreground">
      ...
      case "processing":
        return (
          <div className="py-8 text-center">
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">A processar pagamento...</h3>
            <p className="text-sm text-muted-foreground">
      ...
      case "success":
        return (
          ...
          >
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">Pagamento concluído!</h3>
            <p className="text-sm text-muted-foreground">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-surface-container border-primary/20 p-0 overflow-hidden max-w-md">
    ...
    <button
      ...
      className={`w-full p-4 rounded-xl flex items-center gap-4 transition-all ${
        selected
          ...
          : "bg-surface-container-low border-2 border-transparent hover:border-primary/30"
      }`}
    >
      <div className={`p-3 rounded-xl ${selected ? "bg-primary" : "bg-muted"}`}>
...
export function WalletHistory({ token }: { token: string }) {
  ...
  if (loading) {
    return <div className="animate-pulse h-48 bg-surface-container rounded-xl" />;
  }
        ...
        {transactions.map((tx) => (
          <div key={tx.id} className="p-4 flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              {tx.descricao && (
                <p className="text-xs text-muted-foreground">{tx.descricao}</p>
              )}
